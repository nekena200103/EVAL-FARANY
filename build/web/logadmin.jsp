          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <h4>Hello! Gerons notre clinique ensemble  <span>Admin side</span></h4>
                <h6 class="font-weight-light">Se connecter pour continuer</h6>
                <form class="pt-3" action="<%= request.getContextPath() %>/connexadmin" method="GET">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" name="adminname" placeholder="Username">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="mt-3">
                      <a href="<%= request.getContextPath() %>/user" ><btn class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" value="SE CONNECTER">USER SIDE </btn></a>
                  </div>
