...
<html lang="en">
  ...
  <body style="background-image: url('<%= request.getContextPath() %>/assets/images/bg_1.jpg');">
    
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<%= request.getContextPath() %>/assets/index.html">Event<span>Madagascar</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="<%= request.getContextPath() %>/assets/about.html" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="<%= request.getContextPath() %>/assets/speakers.html" class="nav-link">Speakers</a></li>
	          <li class="nav-item"><a href="<%= request.getContextPath() %>/assets/schedule.html" class="nav-link">Schedule</a></li>
	          <li class="nav-item"><a href="<%= request.getContextPath() %>/assets/blog.html" class="nav-link">Blog</a></li>
	          <li class="nav-item"><a href="<%= request.getContextPath() %>/assets/contact.html" class="nav-link">Contact</a></li>
	          <li class="nav-item cta mr-md-2"><a href="<%= request.getContextPath() %>/assets/#" class="nav-link">Buy ticket</a></li>
    ...
    <% ArrayList<Artiste> list=(ArrayList<Artiste>)request.getAttribute("listeartiste");
    %>
    
    <div class="row block-9" style="margin-top: 10%;">
          <div class="col-md-6 order-md-last d-flex">
            <form action="<%= request.getContextPath() %>/insertionartiste" class="bg-light p-5 contact-form" enctype="multipart/form-data" method="POST" >
                <h2>Inserer vos artistes ici</h2>
              <div class="form-group">
                <input  name="nomartiste" type="text" class="form-control" placeholder="Nom de l'artiste">
              </div>
              <div class="form-group">
                  <input name="tarifparheure" type="number" min="0" max="1000000000" class="form-control" placeholder="Tarif horaire">
              </div>
              <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                            ...
                            <input type="file" name="file" class="file-upload-browse">
                            <input type="file" name="file2" class="file-upload-browse">
          ...
          <div class="col-md-6 d-flex">
              <div id="map" class="bg-transparent" style="margin-left: 10%;">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <%for (int idx = 0; idx < list.size(); idx++) {
                          Artiste elem = (Artiste)list.get(idx);
                          %>
                          <tr>
                              <td><%out.print(elem.getNomartiste());%></td>
                          <td><%out.print(elem.getTarifparheure());%></td>
                          <td><a href="<%= request.getContextPath() %>/deleteartiste?idartiste=<%=elem.getIdartiste() %>&nomartiste=<%=elem.getNomartiste() %>&tarifparheure=<%=elem.getTarifparheure() %>" ><label class="badge badge-danger">Supprimer</label></a></td>
                          <td> <img src="data:image/png;base64,<%=elem.getPhoto()%>" style="width: 10%; height: 10%;"></td>
                          </tr>
